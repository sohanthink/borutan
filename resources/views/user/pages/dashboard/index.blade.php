     ...
     <div class="card radius-10 border-start border-0 border-3 border-danger">
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div class="widgets-icons-2 rounded-circle bg-gradient-bloody text-white ms-auto"><i class='bx bx-buildings'></i>
                </div>
            </div>
        </div>
     </div>
     ...
     <div class="card radius-10 border-start border-0 border-3 border-success">
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div class="widgets-icons-2 rounded-circle bg-success text-white ms-auto"><i class='bx bx-buildings'></i>
                </div>
            </div>
        </div>
     </div>
     ...
     <div class="card radius-10 border-start border-0 border-3 border-primary">
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div class="widgets-icons-2 rounded-circle bg-primary text-white ms-auto"><i class='bx bx-buildings'></i>
                </div>
            </div>
        </div>
     </div>
     ...
     <div class="card radius-10 border-start border-0 border-3 border-warning">
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div class="widgets-icons-2 rounded-circle bg-gradient-blooker text-white ms-auto"><i class='bx bx-buildings'></i>
                </div>
            </div>
        </div>
     </div>
                ...
                <table class="table mb-0 dt-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> 
                                <a href="{{route('user.apartment.show', $inquiry->id)}}" class="text-white btn btn-info"><i class="lni lni-eye"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
