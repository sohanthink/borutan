    ...
    <div class="nav font-primary flex justify-between items-center w-11/12 md:w-4/5 mx-auto py-5">
        ...
        <div class="w-1/4 hidden md:block">
            <ul class="flex gap-8 justify-center font-medium">
                ...
                <li class="whitespace-nowrap"><a href="{{ url('/') }}#about">Om oss</a></li>
                <li class="whitespace-nowrap"><a href="{{ url('/') }}#faq">Frågor & svar</a></li>
        ...
        <div class="w-1/2 md:w-1/3 flex justify-end gap-1 sm:gap-3">
            <a href="{{ route('login') }}"
                class="px-2 py-1 sm:px-4 sm:py-2 bg-[#9628fd] text-white rounded text-nowrap text-sm hidden md:block">Logga
                in</a>
            <a href="{{ route('register') }}"
                class="px-2 py-1 sm:px-4 sm:py-2 bg-[#9628fd] text-white rounded text-nowrap text-sm hidden md:block">Bli
                Medlem</a>
            ...
            <div id="menu" class="hidden menu">
                <ul class="bg-[#1f2937] z-50 text-white absolute top-14 left-0 w-full p-6 space-y-10 text-center">
                    ...
                    <li><a href="{{ route('login') }}"
                            class="px-2 py-1 sm:px-4 sm:py-2 bg-[#9628fd] text-white rounded text-nowrap text-sm">Logga
                            in</a>
                    </li>
                    <li><a href="{{ route('register') }}"
                            class="px-2 py-1 sm:px-4 sm:py-2 bg-[#9628fd] text-white rounded text-nowrap text-sm">Bli
                            Medlem</a></li>
                </ul>
            </div>
        </div>
    ...
    <section class="mt-14 bg-[#1f2937] text-white">
        <div
            ...
            <div class="hidden md:block">
                <ul>
                    <li class="font-bold pb-2 text-xl">Medlemskap</li>
                    ...
                    <a href="{{ route('terms') }}">
                        <li class="py-1 font-thin">Användarvillkor</li>
                    </a>
                    <a href="{{ route('privacy') }}">
                        <li class="py-1 font-thin">Integritetspolicy</li>
                    </a>
                </ul>
            </div>
            <div>
                <ul>
                    <li class="font-bold pb-2 text-xl">Kontakt</li>
            ...
            <div class="hidden md:block">
                <ul>
                    ...
                    <li class="whitespace-nowrap py-1 font-thin"><a href="{{ url('/') }}#about">Om oss</a></li>
                    <li class="py-1 font-thin">Info@borutan.se</li>
                </ul>
            </div>
            <div>
