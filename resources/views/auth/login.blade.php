        ...
        <div class="flex md:gap-20 gap-5 items-center justify-center flex-col md:flex-row">
            ...
            <div
                ...
                <div class="text-center">
                    <h1 class="text-xl md:text-3xl font-semibold text-gray-900">Logga in </h1>
                    <p class="mt-2 text-gray-500 hidden md:block">Logga in nedan för att komma åt ditt konto</p>
                    <p class="mt-2 text-gray-500 md:hidden">Logga in nedan för att<br> komma åt ditt konto</p>
                </div>
                <div class="mt-5">
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="my-6">
                            <button type="submit"
                                class="w-full rounded-md bg-black px-3 py-4 text-white focus:bg-gray-600 focus:outline-none">Logga
                                in</button>
                        </div>
                        <div class="md:hidden">
                            <p class="text-center text-sm text-gray-500">Har du inget konto än?<br>
                                <a href="{{ route('register') }}"
                                    class="font-semibold text-gray-600 hover:underline focus:text-gray-800 focus:outline-none">
                                    Registrera dig.
                                </a>
                            </p> <br>
                            <p class="text-center text-sm text-gray-500">Glömt ditt lösenord?<br>
                        ...
                        <div class="hidden md:block">
                            ...
                            <p class="text-center text-sm text-gray-500">Glömt ditt lösenord?
                                <a href="{{ route('password.request') }}"
                                    class="font-semibold text-gray-600 hover:underline focus:text-gray-800 focus:outline-none">
                                    Återställ lösenord.
                                </a>
