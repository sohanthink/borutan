                    ...
                    <div class="h-full">
                        <div
                            ...
                            <div class="text-center">
                                <h1 class="text-3xl font-semibold text-gray-900">Registrera dig</h1>
                                <p class="mt-2 text-gray-500">Registrera dig nedan för att komma åt ditt konto</p>
                            </div>
                            <div class="mt-5">
                                <form action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="relative mt-6">
                                        ...
                                        <label for="first_name"
                                            class="pointer-events-none absolute top-0 left-0 origin-left -translate-y-1/2 transform text-sm text-gray-800 opacity-75 transition-all duration-100 ease-in-out peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:pl-0 peer-focus:text-sm peer-focus:text-gray-800">Förnamn</label>
                                    </div>
                                    <div class="relative mt-6">
                                        ...
                                        <label for="last_name"
                                            class="pointer-events-none absolute top-0 left-0 origin-left -translate-y-1/2 transform text-sm text-gray-800 opacity-75 transition-all duration-100 ease-in-out peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:pl-0 peer-focus:text-sm peer-focus:text-gray-800">Efternamn</label>
                                    </div>
                                    <div class="relative mt-6">
                                    ...
                                    <div class="relative mt-6">
                                        ...
                                        <label for="password"
                                            class="pointer-events-none absolute top-0 left-0 origin-left -translate-y-1/2 transform text-sm text-gray-800 opacity-75 transition-all duration-100 ease-in-out peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:pl-0 peer-focus:text-sm peer-focus:text-gray-800">Lösenord</label>
                                    </div>
                                    <div class="relative mt-6">
                                        ...
                                        <label for="password_confirmation"
                                            class="pointer-events-none absolute top-0 left-0 origin-left -translate-y-1/2 transform text-sm text-gray-800 opacity-75 transition-all duration-100 ease-in-out peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:pl-0 peer-focus:text-sm peer-focus:text-gray-800">Bekräfta
                                            lösenord </label>
                                    </div>
                                    <div class="my-6 text-center">
                                        ...
                                        <label class="form-check-label" for="flexSwitchCheckChecked">
                                            Jag har läst och godkänner <br> <a
                                                href="{{ route('terms') }}"><u>Användarvillkor</u></a>
                                            & <a href="{{ route('privacy') }}"><u>Integritetspolicy.</u></a>
                                            <label>
                                    </div>
                                    <div class="my-6">
                                        <button type="submit"
                                            class="w-full rounded-md bg-black px-3 py-4 text-white focus:bg-gray-600 focus:outline-none">Registrera
                                            dig </button>
                                    </div>

                                    <p class="text-center text-sm text-gray-500">Har du inget konto än?
                                        <a href="{{ route('login') }}"
                                            class="font-semibold text-gray-600 hover:underline focus:text-gray-800 focus:outline-none">Logga
                                            in.
                                        </a>.
                                    </p>
                                </form>
        ...
        <div class="flex main flex-col md:flex-row">
            ...
            <div class="p-5 md:p-0 md:m-auto">
                <div
                    ...
                    <h1 class="text-3xl font-semibold text-gray-900">Registrera dig</h1>
                    <p class="mt-2 text-gray-500 hidden md:block">Registrera dig nedan för att komma åt ditt konto</p>
                    <p class="mt-2 text-gray-500 md:hidden">Registrera dig nedan för att<br> komma åt ditt konto</p>
                    <div class="mt-5">
                        <form action="{{ route('register') }}" method="POST">
                            @csrf
                            @isset($package)
                            ...
                            <p class="text-center text-sm text-gray-500">Har du redan ett konto?
                                <a href="{{ route('login') }}"
                                    class="font-semibold text-gray-600 hover:underline focus:text-gray-800 focus:outline-none">Logga
                                    in här.
                                </a>
